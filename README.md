...
- Price list by charisma. Better handling of runoff into second window (can't see heading, can't go backwards). Default "being duped" state is TRUE, can we make that false? 
- Date of run (?)
